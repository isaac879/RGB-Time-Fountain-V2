...
//        printi(F("ERROR: PWM out of range (0-255)... PWM value entered = "), PWM);
//    }
//    else if(PWM == 0){
//       flag_pump_off = true; 
//       float percentage = float(PWM) / 2.55;
//       printi(F("Pump duty cycle set to: "), percentage, 1, F("%\n"));
//    }
//    else{
//        flag_pump_off = false;
//        pump_duty_value = PWM;
...
int setDropFrequency(String freq){
...
//                printi(F("Pump duty: "), ((float)pump_duty_value/2.55), 1, F("%\n"));
...
//        PORTD &= ~_BV(PUMP_PIN);  //write port LOW
//    }
//    else if(pump_count >= PUMP_MAX_COUNT && !flag_pump_off){
//        PORTD |= _BV(PUMP_PIN);  //write port HIGH
//        pump_count = 0;
//    }
